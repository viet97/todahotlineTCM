...
public class DbContext {
    ...
    private static SharedPreferences DBDsCongTyResponse,DBaboutRespon, DBloginResponse, DBcontactResponse, DBlistContactTodaName;
    private SharedPreferences.Editor DBDsCongTyResponseEditor,DBaboutResponEditor, DBloginResponseEditor, DBcontactResponseEditor, DBlistContactTodaNameEditor;
    ...
    public DbContext() {
        ...
        this.dsCongTyResponse = new DSCongTyResponse();
